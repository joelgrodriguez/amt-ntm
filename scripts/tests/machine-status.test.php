<?php
/**
 * Regression checks for discontinued-machine routing and content targeting.
 */
...
namespace {
    ...
    ntm_assert(
        \Standard\MachineStatus\is_discontinued('ssq-roof-panel-machine'),
        'The WooCommerce SSQ II slug should resolve as discontinued.'
    );
    ntm_assert(
    ...
    ntm_assert(
        ...
        'The discontinued machine should route to the canonical SSQ3 product page.'
    );
