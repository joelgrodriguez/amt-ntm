            ...
            <header class="container mx-auto">
                <div class="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
                    <div class="grid gap-6 justify-items-start">
                        <span class="badge inline"><?php esc_html_e('Download', 'standard'); ?></span>
            ...
            <div class="container mx-auto lg:grid lg:grid-cols-[1fr_300px] lg:gap-12">
                ...
                <aside class="hidden lg:block border-l border-slate-200 pl-12">
                    <nav class="sticky top-16">
                        <p class="text-sm font-semibold text-slate-900 mb-4"><?php esc_html_e('All Downloads', 'standard'); ?></p>
                        <ul class="grid gap-2">
                            <?php
