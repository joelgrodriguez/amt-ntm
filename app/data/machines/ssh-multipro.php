...
return [
    ...
    'faq' => [
        [
            ...
            'answer'   => __('The SSH produces 7 panel profiles including mechanical seam, snap-lock, and snap-lock with slotted flange options for residential and light commercial roofing.', 'standard'),
        ],
        [
