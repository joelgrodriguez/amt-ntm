        ...
        <div class="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div class="border border-slate-700 bg-slate-800 p-8 grid gap-6">
                <div class="bg-slate-700 aspect-video flex items-center justify-center rounded">
                    <span class="text-slate-400 text-sm font-mono">[Configurator preview / machine illustration]</span>
                </div>
                ...
                <a href="#" class="btn btn-primary w-full">[Open Configurator]</a>
            </div>
            ...
            <div class="border border-slate-700 bg-slate-800 p-8 grid gap-6">
                <div class="grid gap-2 text-center py-6">
                    ...
                    <p class="text-5xl font-bold text-white font-mono">[$ X,XXX]<span class="text-lg text-slate-400 font-sans">/mo</span></p>
                    <p class="text-sm text-slate-500">[Based on XX-month term at X.XX% APR]</p>
                </div>
                <div class="grid gap-3">
                ...
                <a href="#" class="btn btn-outline-light w-full">[Explore Financing]</a>
            </div>

        </div>

        <p class="text-center text-sm text-slate-500">[Or <a href="#" class="text-white underline">talk to a specialist</a> to discuss your specific needs.]</p>
