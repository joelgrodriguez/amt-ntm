 ...
 *
 * Sticky bar that pins below the header after scrolling past the hero.
 * Left: machine switcher dropdown. Center: anchor links to page sections.
 * Right: Build & Quote CTA.
 *
 * @package Standard
