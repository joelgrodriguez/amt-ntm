    ...
    <div class="container section-content">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <?php foreach (array_slice($cards, 0, 4) as $card) : ?>
                <a href="<?php echo esc_url($card['url']); ?>" class="block border border-slate-200 bg-white p-4 grid gap-3 hover:border-slate-400 hover:shadow-md transition-all group">
