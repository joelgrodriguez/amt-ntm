        ...
        <div class="social-proof__slider relative max-w-4xl mx-auto text-center grid justify-center gap-8 lg:gap-10">
            <div class="social-proof__track">
                <?php foreach ($testimonials as $index => $testimonial) : ?>
                    ...
                    >
                        <?php icon('quote', ['class' => 'w-10 h-10 text-blue-300 mx-auto md:w-12 md:h-12']); ?>

                        <p class="text-xl text-blue-700 font-medium leading-relaxed md:text-2xl lg:text-3xl">
                            "<?php echo esc_html($testimonial['quote']); ?>"
                        </p>

                        <footer class="text-blue-600">
                            <cite class="not-italic">
                                <span class="block text-lg font-medium text-blue-700">
