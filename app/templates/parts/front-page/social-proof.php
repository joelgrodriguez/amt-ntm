        ...
        <div class="social-proof__slider relative max-w-4xl mx-auto text-center grid justify-center gap-8 lg:gap-10">
            <div class="social-proof__track">
                <?php foreach ($testimonials as $index => $testimonial) : ?>
                    ...
                    >
                        <?php icon('quote', ['class' => 'w-10 h-10 text-blue-400 mx-auto md:w-12 md:h-12']); ?>
            ...
            <nav class="flex justify-center gap-2" aria-label="<?php echo esc_attr($content['nav_label']); ?>">
                <?php foreach ($testimonials as $index => $testimonial) : ?>
                    <button
                        type="button"
                        class="social-proof__dot h-3 border-none cursor-pointer transition-all duration-200 hover:bg-blue-400 focus-visible:outline-2 focus-visible:outline-blue-500 focus-visible:outline-offset-2 <?php echo $index === 0 ? 'bg-blue-500 w-8' : 'bg-blue-600 w-3'; ?>"
                        data-index="<?php echo esc_attr($index); ?>"
