 ...
 *
 * Utilitarian video player with top/bottom chrome bars. Used on the
 * front page (Who Is NTM), the About page, and single-video posts.
 *
 * Defaults compose the "Who Is NTM" framing: live-dot + title on top
 * left, channel on top right, video-type icon on bottom left, company
 * + LED strip on bottom right.
 *
 * Single-video posts override the slots to read as broadcast chrome:
 * channel top-left, company top-right, date bottom-left, type
 * bottom-right.
 *
        ...
        <div class="border-x border-blue-800 container">
            <div class="flex items-center justify-between py-3 text-xs font-mono uppercase tracking-wider">
                <div class="flex items-center gap-2 pl-3">
                    <?php icon($args['bottom_left_icon'], ['class' => 'w-3 h-3 fill-current']); ?>
