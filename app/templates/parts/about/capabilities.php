...
<section class="bg-white py-16 lg:py-24" aria-labelledby="about-capabilities-title">
    <div class="container">
        <div class="grid lg:grid-cols-12 gap-10 lg:gap-16 mb-12 lg:mb-16">
            <div class="lg:col-span-7 grid gap-6 content-start">
                ...
                <h2 id="about-capabilities-title" class="font-sans font-medium text-blue-900 text-2xl md:text-3xl lg:text-[2.5rem] leading-tight tracking-tight">
        ...
        <ol class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5
            border-t border-blue-200
            [&>li]:border-t [&>li]:border-blue-200 [&>li:first-child]:border-t-0
            md:[&>li]:border-l md:[&>li]:border-blue-200
            md:[&>li:nth-child(2n+1)]:border-l-0 md:[&>li:nth-child(-n+2)]:border-t-0
            lg:[&>li:nth-child(2n+1)]:border-l lg:[&>li:nth-child(5n+1)]:border-l-0 lg:[&>li:nth-child(-n+5)]:border-t-0">
