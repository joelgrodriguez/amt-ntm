        ...
        <div class="grid lg:grid-cols-[1fr_auto] gap-12 lg:gap-16 items-end">
            ...
            <div class="flex lg:justify-end">
                <a
                    ...
                    class="group inline-flex items-center gap-3 px-8 py-4 min-h-14 bg-blue-500 border border-blue-500 text-white font-mono font-medium text-sm uppercase tracking-widest hover:bg-blue-600 hover:border-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-4 focus-visible:ring-offset-blue-900 transition-colors"
                >
