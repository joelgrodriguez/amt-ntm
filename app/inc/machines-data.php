        ...
        'roof-wall' => [
            ...
            'machines' => [
                ...
                [
                    ...
                    'name'              => 'SSH™ MultiPro',
                    'short_name' => 'SSH MultiPro',
                    'descriptor' => 'Residential & light commercial machine',
                    'description' => 'Runs 8 panel profiles up to ~60 feet per minute, sized and priced for residential and light commercial roof crews.',
                    'image'      => $base . '2025/09/20250911_NTM_SSH_1000x1000.png.webp',
                    'url'        => get_product_url('ssh-multipro'),
                    'badge'      => '',
                    'highlights' => [
                        '8 panel profiles for residential and light commercial roofing',
            ...
            'machines' => [
                [
                    ...
                    'specs'      => [
                        ...
                        'lead_time' => 'Contact for availability',
...
function get_gutter_faq_items(): array {
    return [
        ...
        [
            ...
            'answer'   => 'Lead times vary by model and configuration. The MACH II line is our highest-volume product; your account specialist will confirm exact lead time at order.',
        ],
        [
        ...
        [
            ...
            'answer'   => 'Lead times vary by model and configuration. The MACH II line is built in volume, while custom configurations and the BG7 box gutter machine may take longer depending on options. Your account specialist will confirm exact lead time at order.',
        ],
        [
